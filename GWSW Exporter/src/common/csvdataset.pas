...
{
    This unit is a complete copy of the csvdataset.pp file that is
    supplied with Free Pascal version 3.2.3. the reason for this is
    that the Pascal version that is currently included with Lazarus
    contains a bug that causes a memory leak if you use:
    csvdatase.active:= True.
}
...
procedure TCustomCSVDataset.LoadBlobIntoBuffer(FieldDef: TFieldDef; ABlobBuf: PBufBlobField);
begin
  // Do nothing
end;
